"""Pip install script for bedrock.analytics.opal-analytics-cycle2_5_hypothesis_testing*
"""
...
setup(
    name='opals.cycle2_5_hypothesis_testing',
    ...
    description='Gallup Cycle 2 Analysis Hypothesis Testing',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/bedrock-py/opal-ingest-cycle2_5_hypothesis_testing',
    ...
    packages=['opals.cycle2_5_hypothesis_testing'],
